...
def create_folders():
    ...
    for folder_name in ("MSPB PDF Downloads", "ITC PDF Downloads", "IRSPLR PDF Downloads", "OHTAX0 PDF Downloads", "MNSUTB PDF Downloads", "MEWORK PDF Downloads", "MOSU00 HTML Downloads"):
